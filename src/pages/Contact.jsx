        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 lg:p-8 hover:shadow-xl transition-shadow duration-300 border-2 border-transparent hover:border-green-300">
            <div className="text-center mb-4 sm:mb-6">
              ...
              <p className="text-green-600 font-medium mb-3 sm:mb-4 text-sm sm:text-base">
                Coordinator
              </p>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 lg:p-8 hover:shadow-xl transition-shadow duration-300 border-2 border-transparent hover:border-yellow-300">
            <div className="text-center mb-4 sm:mb-6">
              ...
              <p className="text-yellow-600 font-medium mb-3 sm:mb-4 text-sm sm:text-base">
                Coordinator
              </p>
            </div>
      ...
      {/* <div className="mt-12 sm:mt-16">
        <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl shadow-xl p-6 sm:p-8 border-2 border-orange-200">
          <div className="text-center mb-8">
            ...
            <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto px-4">
              Join our vibrant AWS Cloud Club for technical support, resources,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-orange-100">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 text-sm">
                  Join our Discord server for real-time discussions, Q&A
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-orange-100">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 text-sm">
                  Access all our social media, resources, and important links in
                  one place
                </p>
              </div>
          ...
          <div className="mt-8 bg-gradient-to-r from-orange-100 to-amber-100 rounded-xl p-6 border border-orange-200 text-center">
            <p className="text-orange-800 font-medium">
              <span className="text-orange-600">🌟 Special Benefits:</span> AWS
              Cloud Club members get priority access to workshops, exclusive AWS
              credits, and direct mentorship opportunities!
            </p>
          </div>
